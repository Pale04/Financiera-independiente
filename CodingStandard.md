...
La bitácora debe manejarse prioritariamente en cada clase que implemente un _Service Contract_, ya que es la capa de mayor nivel dentro del servidor.
...
### Códigos de error
Para manejar los diferentes resultados o flujos que puede generar la ejecución de un método en la parte del servidor, estos devolverá un código de acuerdo al resultado obtenido, a través de un objeto de la clase _Response_.

Todos los códigos manejados se encuntran en el archivo [StatusCodes.md]()
